...
!      file_1 = 'plane_data/fft_kx_' &
!             //CHAR(MOD(RANK+1,10)+48)//         &
!             '.dat'
!      open(63,file=file_1,form='formatted', &
!      status='unknown')       

!      DO I=0,NX2P
!      write(63,*)I,I+rank*(NX2P+1),KXP(I),KX2P(I),CIKXP(I)
!      ENDDO  
!      close(63)

!      IF (rank .eq.0) then
!       open(63,file='fft_main.dat',form='formatted', &
!      status='unknown')
!       DO I=0,NKX
!        write(63,*)I,KX(I),KX2(I),CIKX(I)
!       ENDDO  
!       close(63)
!      ENDIF

 
      WRITE(6,*) 'FFTW package initialized along X direction'
